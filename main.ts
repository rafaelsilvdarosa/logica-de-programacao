sprites.onOverlap(SpriteKind.Player, SpriteKind.Food, function (sprite, otherSprite) {
    ...
    if (info.score() == 10) {
        ...
        Taco = sprites.create(img`
            ...
            ................................
            `, SpriteKind.Food)
        Taco.setPosition(randint(0, scene.screenWidth()), randint(0, scene.screenHeight()))
    }
})
let Taco: Sprite = null
let name = game.askForString("Qual seu nome?")
game.splash("Bem-vindo, " + name + "!")
Taco = sprites.create(img`
    ..............eeeeeee...........
    ............ee455662e2e.........
    ..........ee45556723e2688.......
